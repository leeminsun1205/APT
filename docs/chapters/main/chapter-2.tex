...
\begin{figure}[h]
    ...
    \caption{So sánh kiến trúc giữa APT và các phương pháp thích nghi đối kháng khác (Nguồn: \cite{li2024one})}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\linewidth]{example-image}
    \caption{Minh họa cấu trúc Soft Prompt và cách chèn vào nhánh văn bản của CLIP (Nguồn: \cite{li2024one})}
...
\end{equation}
Chiến lược này tạo ra một "mục tiêu động" (dynamic target): khi prompt trở nên tốt hơn, nhiễu đối kháng cũng trở nên tinh vi hơn để "đánh lừa" chính prompt đó. Sự cùng tiến hóa (co-evolution) này buộc mô hình phải liên tục thích nghi, dẫn đến khả năng phòng thủ vượt trội mà không làm tăng chi phí tính toán quá mức như trường hợp Perturbed Strategy.
